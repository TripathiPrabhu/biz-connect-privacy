...
export default class EmailAuth {
    constructor() {
        this.transporter = nodemailer.createTransport({
            service: 'gmail',
            auth: {
                user: 'iamabhi7852@gmail.com', // Replace with your email
                pass: 'aneo tlof elwh ykbo' // Replace with your app password
            }
        });
    ...
    async sendDeletionRequest(userData) {
        try {
            console.log(userData)
            const mailOptions = {
                from: 'iamabhi7852@gmail.com', // Use the user's email as the sender
                to: 'iamabhi7852@gmail.com', // Replace with the admin's email
                replyTo: userData.email, // Ensures replies go to the user
                subject: 'Data Deletion Request',
                html: `
                    <h1>Data Deletion Request</h1>
                    <p>The following user has requested to delete their data:</p>
                    <ul>
                    ...
                    <p>This email was sent from the user's email address.</p>
                `
            };

            await this.transporter.sendMail(mailOptions);
            console.log('Data deletion request sent from user\'s email successfully.');
